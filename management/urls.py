...
from .views import (RoomTypeListCreate, RoomTypeDetail, RoomListCreate, RoomDetail, RoomStatusLogList,
                    ...
                    IncomeCategoryListCreate, IncomeCategoryDetail,
                    ...
                    IncomeListCreate, IncomeDetail, IncomeAttachmentCreate, IncomeAttachmentDelete,
                    StayNoteListCreate,
...
urlpatterns = [
    ...
    path('income-categories/', IncomeCategoryListCreate.as_view(), name='income-category-list-create'),
    path('income-categories/<int:pk>/', IncomeCategoryDetail.as_view(), name='income-category-detail'),
    ...
    path('income/<int:pk>/attachments/', IncomeAttachmentCreate.as_view(), name='income-attachment-create'),
    path('income-attachments/<int:pk>/', IncomeAttachmentDelete.as_view(), name='income-attachment-delete'),
    ...
    path('finance/income/', IncomeReportView.as_view(), name='finance-income'),
